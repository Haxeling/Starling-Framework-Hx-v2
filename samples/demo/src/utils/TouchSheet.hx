...
class TouchSheet extends Sprite
{
    ...
    private function onTouch(event : TouchEvent) : Void
    {
        ...
        if (touch != null && touch.tapCount == 2) 
            parent.addChild(this)  // alpha = touch ? 0.8 : 1.0;    // touch = event.getTouch(this, TouchPhase.HOVER);    // enable this code to see when you're hovering over the object    // bring self to front  ;
    }
