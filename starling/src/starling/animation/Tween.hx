...
class Tween extends EventDispatcher implements IAnimatable
{
    ...
    public function reset(target : Dynamic, time : Float, transition : Dynamic = "linear") : Tween
    {
        ...
        if (Std.is(transition, String)) 
            this.transition = try cast(transition, String) catch(e:Dynamic) null
        else if (Std.is(transition, Function)) 
            this.transitionFunc = try cast(transition, Function) catch(e:Dynamic) null
        else 
        throw new ArgumentError("Transition must be either a string or a function");
        
        if (_properties != null)             _properties.length = 0
        else _properties = [];
        if (_startValues != null)             _startValues.length = 0
        else _startValues = [];
        if (_endValues != null)             _endValues.length = 0
        else _endValues = [];
        if (_updateFuncs != null)             _updateFuncs.length = 0
        else _updateFuncs = [];
    ...
    public function advanceTime(time : Float) : Void
    {
        ...
        for (i in 0...numProperties){
            ...
            var updateFunc : Function = try cast(_updateFuncs[i], Function) catch(e:Dynamic) null;
    ...
    {
        var startColor : Int = Int(startValue);
        var endColor : Int = Int(endValue);
        ...
        var newA : Int = startA + (endA - startA) * _progress;
        var newR : Int = startR + (endR - startR) * _progress;
        var newG : Int = startG + (endG - startG) * _progress;
        var newB : Int = startB + (endB - startB) * _progress;
    ...
    private function get_transitionFunc() : Function{return _transitionFunc;
    }
    ...
    private function set_repeatDelay(value : Float) : Float{_repeatDelay = value;
        return value;
    }
    ...
    private function set_reverse(value : Bool) : Bool{_reverse = value;
        return value;
    }
    ...
    private function set_roundToInt(value : Bool) : Bool{_roundToInt = value;
        return value;
    }
    ...
    private function set_onStart(value : Function) : Function{_onStart = value;
        return value;
    }
    ...
    private function set_onUpdate(value : Function) : Function{_onUpdate = value;
        return value;
    }
    ...
    private function set_onRepeat(value : Function) : Function{_onRepeat = value;
        return value;
    }
    ...
    private function set_onComplete(value : Function) : Function{_onComplete = value;
        return value;
    }
    ...
    private function set_onStartArgs(value : Array<Dynamic>) : Array<Dynamic>{_onStartArgs = value;
        return value;
    }
    ...
    private function set_onUpdateArgs(value : Array<Dynamic>) : Array<Dynamic>{_onUpdateArgs = value;
        return value;
    }
    ...
    private function set_onRepeatArgs(value : Array<Dynamic>) : Array<Dynamic>{_onRepeatArgs = value;
        return value;
    }
    ...
    private function set_onCompleteArgs(value : Array<Dynamic>) : Array<Dynamic>{_onCompleteArgs = value;
        return value;
    }
    ...
    private function set_nextTween(value : Tween) : Tween{_nextTween = value;
        return value;
    }
