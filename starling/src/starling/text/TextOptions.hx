...
class TextOptions
{
    ...
    private function set_wordWrap(value : Bool) : Bool{_wordWrap = value;
        return value;
    }
    ...
    private function get_autoScale() : Bool{return _autoScale;
    }
    private function set_autoScale(value : Bool) : Bool{_autoScale = value;
        return value;
    }
    ...
    private function get_isHtmlText() : Bool{return _isHtmlText;
    }
    private function set_isHtmlText(value : Bool) : Bool{_isHtmlText = value;
        return value;
    }
    
    /** The scale factor of any textures that are created during text composition.
     *  @default Starling.contentScaleFactor */
    private function get_textureScale() : Float{return _textureScale;
    }
    private function set_textureScale(value : Float) : Float{_textureScale = value;
        return value;
    }
    ...
    private function set_textureFormat(value : String) : String{_textureFormat = value;
        return value;
    }
}
