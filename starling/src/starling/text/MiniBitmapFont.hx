...
class MiniBitmapFont
{
    ...
    private static var XML_DATA : FastXML = FastXML.parse("<font>
    ...
    private static function getBitmapData() : BitmapData
    {
        ...
        for (i in 0...numBytes){bmpBytes.writeUnsignedInt(BITMAP_DATA[i]);
        }
    ...
    private static function get_xml() : FastXML{return XML_DATA;
    }
