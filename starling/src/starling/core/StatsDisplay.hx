...
class StatsDisplay extends Sprite
{
    ...
    private inline var UPDATE_INTERVAL : Float = 0.5;
    ...
    private function get_fps() : Float{return _fps;
    }
    private function set_fps(value : Float) : Float{_fps = value;
        return value;
    }
    
    /** The currently required system memory in MB. */
    private function get_memory() : Float{return _memory;
    }
    private function set_memory(value : Float) : Float{_memory = value;
        return value;
    }
}
