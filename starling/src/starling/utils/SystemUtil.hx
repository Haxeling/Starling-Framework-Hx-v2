...
import starling.utils.Namespace;
...
class SystemUtil
{
    ...
    public static function executeWhenApplicationIsActive(call : Function) : Void
    {
        initialize();
    ...
    {
        initialize();
        return new EReg('(WIN|MAC|LNX)', "").exec(sPlatform) != null;
    }
