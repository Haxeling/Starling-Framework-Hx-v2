...
class SubTexture extends Texture
{
    ...
    /** @inheritDoc */
    override private function get_transformationMatrix() : Matrix{return _transformationMatrix;
    }
    
    /** @inheritDoc */
    override private function get_transformationMatrixToRoot() : Matrix{return _transformationMatrixToRoot;
    }
    
    /** @inheritDoc */
    override private function get_base() : TextureBase{return _parent.base;
    }
    
    /** @inheritDoc */
    override private function get_root() : ConcreteTexture{return _parent.root;
    }
    
    /** @inheritDoc */
    override private function get_format() : String{return _parent.format;
    }
    ...
    /** @inheritDoc */
    override private function get_nativeWidth() : Float{return _width * scale;
    }
    
    /** @inheritDoc */
    override private function get_nativeHeight() : Float{return _height * scale;
    }
    
    /** @inheritDoc */
    override private function get_mipMapping() : Bool{return _parent.mipMapping;
    }
    
    /** @inheritDoc */
    override private function get_premultipliedAlpha() : Bool{return _parent.premultipliedAlpha;
    }
    
    /** @inheritDoc */
    override private function get_scale() : Float{return _parent.scale;
    }
    
    /** @inheritDoc */
    override private function get_frame() : Rectangle{return _frame;
    }
}
