...
class DisplayObject extends EventDispatcher
{
            ...
            out : Matrix = null) : Matrix
    {
        ...
        if (commonParent == targetSpace) 
            return out  // 3. now move up from target until we reach the common parent  ;
    ...
    public function hitTest(localPoint : Point) : DisplayObject
    {
        ...
        if (!_visible || !_touchable)             return null  // if we've got a mask and the hit occurs outside, fail  ;
        
        
        
        if (_mask != null && !hitTestMask(localPoint))             return null  // otherwise, check bounding box  ;
    ...
    public function hitTestMask(localPoint : Point) : Bool
    {
        if (_mask != null) 
        {
            ...
            var helperPoint : Point = localPoint == (sHelperPoint != null) ? new Point() : sHelperPoint;
    ...
    private function set_scale(value : Float) : Float{scaleX = scaleY = value;
        return value;
    }
    ...
    private function set_touchable(value : Bool) : Bool{_touchable = value;
        return value;
    }
    ...
    private function set_name(value : String) : String{_name = value;
        return value;
    }
     ...
     *  to the stage. */
    private function get_stage() : Stage{return try cast(this.base, Stage) catch(e:Dynamic) null;
    }
}
