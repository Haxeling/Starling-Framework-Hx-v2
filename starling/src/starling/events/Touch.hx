...
class Touch
{
    ...
    {
        return StringTools.format("[Touch {0}: globalX={1}, globalY={2}, phase={3}]",
    ...
    private function updateBubbleChain() : Void
    {
        if (_target != null) 
        {
            ...
            _bubbleChain[as3hx.Compat.parseInt(length++)] = element;
        }
        else 
        {
    ...
    private function get_previousGlobalX() : Float{return _previousGlobalX;
    }
    
    /** The previous y-position of the touch in stage coordinates. */
    private function get_previousGlobalY() : Float{return _previousGlobalY;
    }
    ...
    private function get_globalX() : Float{return _globalX;
    }
    ...
    private function get_globalY() : Float{return _globalY;
    }
    ...
    private function get_tapCount() : Int{return _tapCount;
    }
    private function set_tapCount(value : Int) : Int{_tapCount = value;
        return value;
    }
    
    /** The current phase the touch is in. @see TouchPhase */
    private function get_phase() : String{return _phase;
    }
    private function set_phase(value : String) : String{_phase = value;
        return value;
    }
    ...
    private function set_timestamp(value : Float) : Float{_timestamp = value;
        return value;
    }
    
    /** A value between 0.0 and 1.0 indicating force of the contact with the device. 
     *  If the device does not support detecting the pressure, the value is 1.0. */
    private function get_pressure() : Float{return _pressure;
    }
    private function set_pressure(value : Float) : Float{_pressure = value;
        return value;
    }
    ...
    private function set_width(value : Float) : Float{_width = value;
        return value;
    }
    ...
    private function set_height(value : Float) : Float{_height = value;
        return value;
    }
    ...
    private function get_cancelled() : Bool{return _cancelled;
    }
    private function set_cancelled(value : Bool) : Bool{_cancelled = value;
        return value;
    }
